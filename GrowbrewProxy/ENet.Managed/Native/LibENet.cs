...
namespace ENet.Managed.Native
{
    ...
    public static unsafe class LibENet
    {
        ...
        [UnmanagedFunctionPointer(ENetCallingConvention)]
        public delegate void HostEnableNewProtocolDelegate(IntPtr host, int state);
        public static HostEnableNewProtocolDelegate HostEnableNewProtocol { get; private set; }
