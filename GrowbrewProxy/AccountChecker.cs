...
namespace GrowbrewProxy
{
    public class AccountChecker
    {
        ...
        internal static int checkCurrentIndex;
        ...
        private static void Peer_OnReceive_Client(object sender, ENetPacket e)
        {
            try
            {
                ...
                Console.WriteLine("RECEIVE TYPE: " + packet[0]);
                switch (packet[0])
                {
                    ...
                    case (byte) NetTypes.NetMessages.TRACK: // TRACK packet.
                    {
                        ...
                        checkCurrentIndex++;
                        Console.WriteLine(
                            "[ACCOUNT-CHECKER] +1 account checked, disconnecting and moving onto the next one.");
        ...
        public static bool Initialize()
        {
            ...
            if (g_Client != null) return true;
            AllocConsole();
            Console.WriteLine(
                "[ACCOUNT-CHECKER] Account Checker Bot/Client (C) 2020 playingo (aka DEERUX), github.com/playingoDEERUX/growbrewproxy\n" +
            ...
            {
                Console.WriteLine(
                    "[ACCOUNT-CHECKER] ERROR: Could not start Account Checking, accountsToCheck list was null.");
                return false;
            }
            ...
            {
                Console.WriteLine(
                    "[ACCOUNT-CHECKER] ERROR: Could not start Account Checking, there were no accounts loaded.");
                return false;
            }
        ...
        public static void ConnectCurrent()
        {
            ...
            if (!g_Client.ServiceThreadStarted) return;
            if (g_Peer == null)
            {
                g_Peer = g_Client.Connect(new IPEndPoint(IPAddress.Parse(Growtopia_IP), Growtopia_Port), 2, 0);
            }
